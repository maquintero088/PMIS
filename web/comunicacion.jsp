...
<html>
    ...
    <body>
        <div id="page-wrap">               
        <header class="azul">   
            <img src="IMAGES/comunicacion.png" class="bimg" name="comunicacion" alt="comunicacion" onclick="document.location='http://localhost:8080/PMIS_Tigo_PMO/comunicacion.jsp'"/> 
            <hr>
        </header>
        <aside> 
