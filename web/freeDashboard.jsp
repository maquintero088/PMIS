...
<html>
  ...
  <body>
      <div id="page-wrap">
          <header>   
          <img src="IMAGES/freedashboard.png" name="Dashboard" class="bimg" alt="dashboard" onclick="document.location='http://localhost:8080/PMIS_Tigo_PMO/freeDashboard.jsp'"/>                                               
          <hr>
          <br>
      </header>
       <aside class="right">
