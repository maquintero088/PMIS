...
<%}%>
  ...
  <body>
      <div id="page-wrap">
          <header>   
          <img src="images/vistainterna.png" name="Dashboard" class="bimg" alt="dashboard" onclick="document.location='primeDashboard.jsp'"/>                                               
          <hr> 
          <br>
      ...
      <aside class="right">
        ...
        <div class="full">            
            ...
            <object  type="text/html" style="height: 500px" data="dsh_8.jsp" standby="Cargando..."></object>
        </div>
        <div class="full">            
            <table>
                <tr>
            ...
            <object  type="text/html" style="height: 500px" data="dsh_9.jsp" standby="Cargando..."></object>
        </div>
        <div class="blanco2">
            <div class="blanco">
                <table>
        ...
        <div class="full">            
            ...
            <object style="height: 500px" type="text/html" data="dsh_<%=G%>.jsp" standby="Cargando..."></object>
        </div>
        <%}%>
