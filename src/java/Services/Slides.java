    ...
    private String[][] 
            ...
            limpiarTable = {
                ...
                {   "<body style=\"font-family: \'calibri\';\n" +
                    ...
                    "src=\"http://localhost:8080/PMIS_Tigo_PMO/IMAGES/comunicacion/"
                }
            },
            limpiarTable2 = {
                {
                    "<!DOCTYPE html>","</body>","<html>","</html>","<body>",
                    "<img class=\"full\" src=\"http://localhost:8080/PMIS_Tigo_PMO/IMAGES/comunicacion/com-foo.png\" name=\"Requerimientos\" alt=\"fases\" />"
                },
                {"<!--","","","","-->",
                    ""}};; 
