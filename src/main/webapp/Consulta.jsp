...
<%@page import="com.qcmarcel.PMIS.Servicios.Slides"%>
...
%>  
    ...
    <body>             
        <div id="page-wrap">
            <header>   
          <img src="images/Consulta.png" name="Dashboard" class="bimg" alt="dashboard" onclick="document.location='Consulta.jsp'"/>                                               
          <hr>   
          <br>
      </header>
          <section>
   ...
   <%}else if(new Negocio().count("PMO_STATUS_PROYECTOS", "ID_STATUS_PROYECTOS", "PMO_PROYECTO", D[0])==null){%>
       <article>
           ...
           <input type="button" class="bt" value="Volver" onclick="document.location='Consulta.jsp'"/> 
       </article>
   <%}else{
            String [] 
